...
START_TEST(min_max4) {
  // arrange
  s21_decimal value_1 = {.bits = {S21_MAX_INT, S21_MAX_INT, S21_MAX_INT}};
  value_1.bits[3] = S21_MAKE_EXP(29, 1);
  s21_decimal value_2 = {.bits = {S21_MAX_INT, S21_MAX_INT, S21_MAX_INT}};
  value_2.bits[3] = S21_MAKE_EXP(29, 1);
...
START_TEST(not_norm1) {
  // arrange
  s21_decimal value_1 = {.bits = {123000}};
  value_1.bits[3] = S21_MAKE_EXP(3, 0);
  s21_decimal value_2 = {.bits = {1230}};
  value_2.bits[3] = S21_MAKE_EXP(1, 0);
...
END_TEST
START_TEST(not_norm2) {
  // arrange
  s21_decimal value_1 = {.bits = {123}};
  value_1.bits[3] = S21_MAKE_EXP(0, 0);
  s21_decimal value_2 = {.bits = {12300000}};
...
END_TEST
START_TEST(not_norm3) {
  // arrange
  s21_decimal value_1 = {.bits = {123}};
  value_1.bits[3] = S21_MAKE_EXP(0, 1);
  s21_decimal value_2 = {.bits = {12300000}};
  value_2.bits[3] = S21_MAKE_EXP(5, 1);
...
END_TEST
START_TEST(not_norm4) {
  // arrange
  s21_decimal value_1 = {.bits = {0}};
  value_1.bits[3] = S21_MAKE_EXP(30, 1);
  s21_decimal value_2 = {.bits = {123}};
  value_2.bits[3] = S21_MAKE_EXP(35, 0);
...
Suite *is_not_equal_sc(void) {
  ...
  tcase_add_test(tc, min_max3);
  tcase_add_test(tc, min_max4);
  tcase_add_test(tc, min_max5);
  ...
  tcase_add_test(tc, not_norm1);
  tcase_add_test(tc, not_norm2);
  tcase_add_test(tc, not_norm3);
  tcase_add_test(tc, not_norm4);
  tcase_add_test(tc, not_norm5);
  tcase_add_test(tc, not_norm6);
  tcase_add_test(tc, not_norm7);
  tcase_add_test(tc, not_norm8);
