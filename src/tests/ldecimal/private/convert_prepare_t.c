...
START_TEST(t1) {
  ...
  s21_ldecimal need_result_num = {.bits = {123456}, .exp = 3, .sign = 1};
  int need_result = 0;

  // act
  int result = s21_ldec_convert_prepare(&num);
...
START_TEST(error1) {
  ...
  s21_ldecimal need_result_num = {
      .bits = {0x71136A83, 0xC96DD6FC, 0x8EE90FFC, 1}};
  int need_result = 1;
...
START_TEST(error3) {
  ...
  s21_ldecimal need_result_num = {
      .bits = {0x00000000, 0x00000000, 0x00000000, 0x1}};
  int need_result = 1;
...
START_TEST(overflow1) {
  ...
  s21_ldecimal need_result_num = {.bits = {0xD82BB6D3, 0x7CE4F03A, 0x3FD35EB}};
  int need_result = 0;
...
START_TEST(overflow3) {
  ...
  s21_ldecimal need_result_num = {.bits = {12345679}, .exp = 28};
  int need_result = 0;
...
START_TEST(overflow4) {
  ...
  s21_ldecimal need_result_num = {.bits = {1}, .exp = 28};
  int need_result = 0;
...
START_TEST(overflow5) {
  ...
  s21_ldecimal need_result_num = {0};
  int need_result = 0;
...
START_TEST(overflow9) {
  ...
  s21_ldecimal need_result_num = {.bits = {2}, .exp = 28};
  int need_result = 0;
...
START_TEST(overflow10) {
  ...
  s21_ldecimal need_result_num = {.bits = {0x9999999A, 0x99999999, 0x19999999},
                                  .exp = 27};
  int need_result = 0;
...
START_TEST(overflow12) {
  ...
  s21_ldecimal need_result_num = {.bits = {0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF}};
  int need_result = 0;
...
START_TEST(round_no_need1) {
  ...
  s21_ldecimal need_result_num = {.bits = {0x71B52440, 0xE0F1624C, 0x27E41B32},
                                  .exp = 14};
  int need_result = 0;
...
START_TEST(round1) {
  ...
  s21_ldecimal need_result_num = {.bits = {0x71B52442, 0xE0F1624C, 0x27E41B32}};
  int need_result = 0;
...
START_TEST(round3) {
  ...
  s21_ldecimal need_result_num = {.bits = {0x71B52441, 0xE0F1624C, 0x27E41B32}};
  int need_result = 0;
...
START_TEST(round4) {
  ...
  s21_ldecimal need_result_num = {.bits = {0x20000000, 0x7C4A04C2, 0x409F9CBC}};
  int need_result = 0;
...
START_TEST(round5) {
  ...
  s21_ldecimal need_result_num = {.bits = {0x1FFFFFFF, 0x7C4A04C2, 0x409F9CBC}};
  int need_result = 0;
...
START_TEST(maxnum) {
  ...
  s21_ldecimal need_result_num = {.bits = {UINT32_MAX, UINT32_MAX, UINT32_MAX}};
  int need_result = 0;
...
TCase *ldec_convert_prepare_tc(void) {
  TCase *tc = tcase_create("s21_ldec_convert_prepare");
